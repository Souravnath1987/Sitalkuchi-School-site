...
export function Hero() {
  ...
  return (
    <>
    <section id="home" className="relative bg-brand-green-900 overflow-hidden w-full h-[60vh] md:h-[70vh] lg:h-[85vh] mt-[104px] sm:mt-[116px]">
    ...
    <div className="bg-brand-cream text-center py-10 px-4 sm:px-8 border-b-4 border-brand-gold/20 overflow-hidden">
      <div className="max-w-5xl mx-auto py-4">
        <h2 className="font-stylish text-brand-green-900 font-bold text-4xl sm:text-5xl md:text-6xl lg:text-7xl mb-2 leading-tight whitespace-nowrap">
...
export function HeroWelcome() {
  return (
    <div className="py-12 md:py-16 px-4 sm:px-8 max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
